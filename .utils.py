...
[docs]def memoize(f, refresh_keyword='mrefresh'):
    """
...
[docs]def clean_tickers(tickers):
    """
...
[docs]def as_percent(self, digits=2):
    return as_format(self, '.%s%%' % digits)



[docs]def as_format(item, format_str='.2f'):
    """
